...
$.template('mqOverviewMap',
    ...
    '<div class="mq-overviewmap-close ui-icon ui-icon-arrowthick-1-se" title="${close}"></div>'+
    '</div>'+
...
$.widget("mapQuery.mqOverviewMap", {
    ...
    //get the mapquery object
        ...
        var dialogElement = $('#'+id).dialog({
            ...
            'mq-overviewmap-open ui-icon-arrowthick-1-nw').attr('title', $.i18n.prop('txt_showover'));
            }
        ...
        'mq-overviewmap-close ui-icon-arrowthick-1-se').attr('title', $.i18n.prop('txt_hideover'));
            $('#'+id).dialog('open');
        });
    },
    _destroy: function() {
